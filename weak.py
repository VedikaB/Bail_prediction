...
"""
poke_df_sub = bail[['Gender','co-accused','Law of Parity']]
poke_df_sub1= bail[['Period of custody','Differences b/w chargesheet and trials','Accused presented within 24 hrs','Proof with accused','Delay in launching FIR/producing chargesheet','logical output','Output']]
...
fbail = pd.concat([poke_df_sub, poke_df_sub1], axis=1)
columns = sum([['Gender','co-accused','Law of Parity']] , [])
fbail[columns]
"""
